...
float AShootingGameCharacter::TakeDamage(float DamageAmount, FDamageEvent const& DamageEvent, AController* EventInstigator, AActor* DamageCauser)
{
	GEngine->AddOnScreenDebugMessage(-1, 5.f, FColor::Yellow, 
		FString::Printf(TEXT("TakeDamage Damage=%f EventInstigator=%s"), 
		DamageAmount, *EventInstigator->GetName()));
...
{
	GEngine->AddOnScreenDebugMessage(-1, 5.f, FColor::Yellow, TEXT("PressTestKey"));
...
void AShootingGameCharacter::TestSetOwnerWeapon()
{
	...
	{
		GEngine->AddOnScreenDebugMessage(-1, 5.f, FColor::Yellow, 
			FString::Printf(TEXT("SetOwnerWeaponOwner : %s"), *GetController()->GetName()));
	...
	timerManager.SetTimer(th_SetOwnerWeapon, this, 
		&AShootingGameCharacter::TestSetOwnerWeapon, 0.1f, false);
}
